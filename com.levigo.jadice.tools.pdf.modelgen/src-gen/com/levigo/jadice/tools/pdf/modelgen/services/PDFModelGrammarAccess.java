...
public class PDFModelGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class PDFModelElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cConfigModelConfigParserRuleCall_0_0 = (RuleCall)cConfigAssignment_0.eContents().get(0);
		...
		//ModelConfig
		public RuleCall getConfigModelConfigParserRuleCall_0_0() { return cConfigModelConfigParserRuleCall_0_0; }
	...
	public class ModelConfigElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ModelConfig");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Assignment cBasePackageAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cBasePackageQualifiedNameParserRuleCall_3_0 = (RuleCall)cBasePackageAssignment_3.eContents().get(0);
		private final Keyword cSemicolonKeyword_4 = (Keyword)cGroup.eContents().get(4);
		private final Assignment cCoreTypesConfigAssignment_5 = (Assignment)cGroup.eContents().get(5);
		private final RuleCall cCoreTypesConfigCoreTypesConfigParserRuleCall_5_0 = (RuleCall)cCoreTypesConfigAssignment_5.eContents().get(0);
		...
		public Assignment getBasePackageAssignment_3() { return cBasePackageAssignment_3; }

		//QualifiedName
		public RuleCall getBasePackageQualifiedNameParserRuleCall_3_0() { return cBasePackageQualifiedNameParserRuleCall_3_0; }

		//";"
		public Keyword getSemicolonKeyword_4() { return cSemicolonKeyword_4; }

		//coreTypesConfig=CoreTypesConfig
		public Assignment getCoreTypesConfigAssignment_5() { return cCoreTypesConfigAssignment_5; }

		//CoreTypesConfig
		public RuleCall getCoreTypesConfigCoreTypesConfigParserRuleCall_5_0() { return cCoreTypesConfigCoreTypesConfigParserRuleCall_5_0; }

		//"}"
		public Keyword getRightCurlyBracketKeyword_6() { return cRightCurlyBracketKeyword_6; }
	}

	public class CoreTypesConfigElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "CoreTypesConfig");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cCoreTypesKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Keyword cLeftCurlyBracketKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Keyword cObjectKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Assignment cObjectTypeNameAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cObjectTypeNameQualifiedNameParserRuleCall_3_0 = (RuleCall)cObjectTypeNameAssignment_3.eContents().get(0);
		private final Keyword cSemicolonKeyword_4 = (Keyword)cGroup.eContents().get(4);
		private final Keyword cReferenceKeyword_5 = (Keyword)cGroup.eContents().get(5);
		private final Assignment cReferenceTypeNameAssignment_6 = (Assignment)cGroup.eContents().get(6);
		private final RuleCall cReferenceTypeNameQualifiedNameParserRuleCall_6_0 = (RuleCall)cReferenceTypeNameAssignment_6.eContents().get(0);
		private final Keyword cSemicolonKeyword_7 = (Keyword)cGroup.eContents().get(7);
		private final Keyword cDictionaryKeyword_8 = (Keyword)cGroup.eContents().get(8);
		private final Assignment cDictionaryTypeNameAssignment_9 = (Assignment)cGroup.eContents().get(9);
		private final RuleCall cDictionaryTypeNameQualifiedNameParserRuleCall_9_0 = (RuleCall)cDictionaryTypeNameAssignment_9.eContents().get(0);
		private final Keyword cSemicolonKeyword_10 = (Keyword)cGroup.eContents().get(10);
		private final Keyword cNameKeyword_11 = (Keyword)cGroup.eContents().get(11);
		private final Assignment cNameTypeNameAssignment_12 = (Assignment)cGroup.eContents().get(12);
		private final RuleCall cNameTypeNameQualifiedNameParserRuleCall_12_0 = (RuleCall)cNameTypeNameAssignment_12.eContents().get(0);
		private final Keyword cSemicolonKeyword_13 = (Keyword)cGroup.eContents().get(13);
		private final Keyword cStringKeyword_14 = (Keyword)cGroup.eContents().get(14);
		private final Assignment cStringTypeNameAssignment_15 = (Assignment)cGroup.eContents().get(15);
		private final RuleCall cStringTypeNameQualifiedNameParserRuleCall_15_0 = (RuleCall)cStringTypeNameAssignment_15.eContents().get(0);
		private final Keyword cSemicolonKeyword_16 = (Keyword)cGroup.eContents().get(16);
		private final Keyword cLiteralStringKeyword_17 = (Keyword)cGroup.eContents().get(17);
		private final Assignment cLiteralStringTypeNameAssignment_18 = (Assignment)cGroup.eContents().get(18);
		private final RuleCall cLiteralStringTypeNameQualifiedNameParserRuleCall_18_0 = (RuleCall)cLiteralStringTypeNameAssignment_18.eContents().get(0);
		private final Keyword cSemicolonKeyword_19 = (Keyword)cGroup.eContents().get(19);
		private final Keyword cHexStringKeyword_20 = (Keyword)cGroup.eContents().get(20);
		private final Assignment cHexStringTypeNameAssignment_21 = (Assignment)cGroup.eContents().get(21);
		private final RuleCall cHexStringTypeNameQualifiedNameParserRuleCall_21_0 = (RuleCall)cHexStringTypeNameAssignment_21.eContents().get(0);
		private final Keyword cSemicolonKeyword_22 = (Keyword)cGroup.eContents().get(22);
		private final Keyword cArrayKeyword_23 = (Keyword)cGroup.eContents().get(23);
		private final Assignment cArrayTypeNameAssignment_24 = (Assignment)cGroup.eContents().get(24);
		private final RuleCall cArrayTypeNameQualifiedNameParserRuleCall_24_0 = (RuleCall)cArrayTypeNameAssignment_24.eContents().get(0);
		private final Keyword cSemicolonKeyword_25 = (Keyword)cGroup.eContents().get(25);
		private final Keyword cBooleanKeyword_26 = (Keyword)cGroup.eContents().get(26);
		private final Assignment cBooleanTypeNameAssignment_27 = (Assignment)cGroup.eContents().get(27);
		private final RuleCall cBooleanTypeNameQualifiedNameParserRuleCall_27_0 = (RuleCall)cBooleanTypeNameAssignment_27.eContents().get(0);
		private final Keyword cSemicolonKeyword_28 = (Keyword)cGroup.eContents().get(28);
		private final Keyword cNumberKeyword_29 = (Keyword)cGroup.eContents().get(29);
		private final Assignment cNumberTypeNameAssignment_30 = (Assignment)cGroup.eContents().get(30);
		private final RuleCall cNumberTypeNameQualifiedNameParserRuleCall_30_0 = (RuleCall)cNumberTypeNameAssignment_30.eContents().get(0);
		private final Keyword cSemicolonKeyword_31 = (Keyword)cGroup.eContents().get(31);
		private final Keyword cRealKeyword_32 = (Keyword)cGroup.eContents().get(32);
		private final Assignment cRealTypeNameAssignment_33 = (Assignment)cGroup.eContents().get(33);
		private final RuleCall cRealTypeNameQualifiedNameParserRuleCall_33_0 = (RuleCall)cRealTypeNameAssignment_33.eContents().get(0);
		private final Keyword cSemicolonKeyword_34 = (Keyword)cGroup.eContents().get(34);
		private final Keyword cIntegerKeyword_35 = (Keyword)cGroup.eContents().get(35);
		private final Assignment cIntegerTypeNameAssignment_36 = (Assignment)cGroup.eContents().get(36);
		private final RuleCall cIntegerTypeNameQualifiedNameParserRuleCall_36_0 = (RuleCall)cIntegerTypeNameAssignment_36.eContents().get(0);
		private final Keyword cSemicolonKeyword_37 = (Keyword)cGroup.eContents().get(37);
		private final Keyword cNullKeyword_38 = (Keyword)cGroup.eContents().get(38);
		private final Assignment cNullTypeNameAssignment_39 = (Assignment)cGroup.eContents().get(39);
		private final RuleCall cNullTypeNameQualifiedNameParserRuleCall_39_0 = (RuleCall)cNullTypeNameAssignment_39.eContents().get(0);
		private final Keyword cSemicolonKeyword_40 = (Keyword)cGroup.eContents().get(40);
		private final Keyword cStreamKeyword_41 = (Keyword)cGroup.eContents().get(41);
		private final Assignment cStreamTypeNameAssignment_42 = (Assignment)cGroup.eContents().get(42);
		private final RuleCall cStreamTypeNameQualifiedNameParserRuleCall_42_0 = (RuleCall)cStreamTypeNameAssignment_42.eContents().get(0);
		private final Keyword cSemicolonKeyword_43 = (Keyword)cGroup.eContents().get(43);
		private final Keyword cRightCurlyBracketKeyword_44 = (Keyword)cGroup.eContents().get(44);
		private final Keyword cUtilTypesKeyword_45 = (Keyword)cGroup.eContents().get(45);
		private final Keyword cLeftCurlyBracketKeyword_46 = (Keyword)cGroup.eContents().get(46);
		private final Keyword cNameTreeKeyword_47 = (Keyword)cGroup.eContents().get(47);
		private final Assignment cNameTreeTypeNameAssignment_48 = (Assignment)cGroup.eContents().get(48);
		private final RuleCall cNameTreeTypeNameQualifiedNameParserRuleCall_48_0 = (RuleCall)cNameTreeTypeNameAssignment_48.eContents().get(0);
		private final Keyword cSemicolonKeyword_49 = (Keyword)cGroup.eContents().get(49);
		private final Keyword cNumberTreeKeyword_50 = (Keyword)cGroup.eContents().get(50);
		private final Assignment cNumberTreeTypeNameAssignment_51 = (Assignment)cGroup.eContents().get(51);
		private final RuleCall cNumberTreeTypeNameQualifiedNameParserRuleCall_51_0 = (RuleCall)cNumberTreeTypeNameAssignment_51.eContents().get(0);
		private final Keyword cSemicolonKeyword_52 = (Keyword)cGroup.eContents().get(52);
		private final Keyword cNameTreeParserKeyword_53 = (Keyword)cGroup.eContents().get(53);
		private final Assignment cNameTreeParserTypeNameAssignment_54 = (Assignment)cGroup.eContents().get(54);
		private final RuleCall cNameTreeParserTypeNameQualifiedNameParserRuleCall_54_0 = (RuleCall)cNameTreeParserTypeNameAssignment_54.eContents().get(0);
		private final Keyword cSemicolonKeyword_55 = (Keyword)cGroup.eContents().get(55);
		private final Keyword cNumberTreeParserKeyword_56 = (Keyword)cGroup.eContents().get(56);
		private final Assignment cNumberTreeParserTypeNameAssignment_57 = (Assignment)cGroup.eContents().get(57);
		private final RuleCall cNumberTreeParserTypeNameQualifiedNameParserRuleCall_57_0 = (RuleCall)cNumberTreeParserTypeNameAssignment_57.eContents().get(0);
		private final Keyword cSemicolonKeyword_58 = (Keyword)cGroup.eContents().get(58);
		private final Keyword cRightCurlyBracketKeyword_59 = (Keyword)cGroup.eContents().get(59);
		...
		//"core-types"
		public Keyword getCoreTypesKeyword_0() { return cCoreTypesKeyword_0; }
		...
		public Assignment getObjectTypeNameAssignment_3() { return cObjectTypeNameAssignment_3; }

		//QualifiedName
		public RuleCall getObjectTypeNameQualifiedNameParserRuleCall_3_0() { return cObjectTypeNameQualifiedNameParserRuleCall_3_0; }
		...
		public Assignment getReferenceTypeNameAssignment_6() { return cReferenceTypeNameAssignment_6; }

		//QualifiedName
		public RuleCall getReferenceTypeNameQualifiedNameParserRuleCall_6_0() { return cReferenceTypeNameQualifiedNameParserRuleCall_6_0; }
		...
		public Assignment getDictionaryTypeNameAssignment_9() { return cDictionaryTypeNameAssignment_9; }

		//QualifiedName
		public RuleCall getDictionaryTypeNameQualifiedNameParserRuleCall_9_0() { return cDictionaryTypeNameQualifiedNameParserRuleCall_9_0; }
		...
		public Assignment getNameTypeNameAssignment_12() { return cNameTypeNameAssignment_12; }

		//QualifiedName
		public RuleCall getNameTypeNameQualifiedNameParserRuleCall_12_0() { return cNameTypeNameQualifiedNameParserRuleCall_12_0; }

		//";"
		public Keyword getSemicolonKeyword_13() { return cSemicolonKeyword_13; }

		//"string"
		public Keyword getStringKeyword_14() { return cStringKeyword_14; }

		//stringTypeName=QualifiedName
		public Assignment getStringTypeNameAssignment_15() { return cStringTypeNameAssignment_15; }

		//QualifiedName
		public RuleCall getStringTypeNameQualifiedNameParserRuleCall_15_0() { return cStringTypeNameQualifiedNameParserRuleCall_15_0; }

		//";"
		public Keyword getSemicolonKeyword_16() { return cSemicolonKeyword_16; }

		//"literal-string"
		public Keyword getLiteralStringKeyword_17() { return cLiteralStringKeyword_17; }

		//literalStringTypeName=QualifiedName
		public Assignment getLiteralStringTypeNameAssignment_18() { return cLiteralStringTypeNameAssignment_18; }

		//QualifiedName
		public RuleCall getLiteralStringTypeNameQualifiedNameParserRuleCall_18_0() { return cLiteralStringTypeNameQualifiedNameParserRuleCall_18_0; }

		//";"
		public Keyword getSemicolonKeyword_19() { return cSemicolonKeyword_19; }

		//"hex-string"
		public Keyword getHexStringKeyword_20() { return cHexStringKeyword_20; }

		//hexStringTypeName=QualifiedName
		public Assignment getHexStringTypeNameAssignment_21() { return cHexStringTypeNameAssignment_21; }

		//QualifiedName
		public RuleCall getHexStringTypeNameQualifiedNameParserRuleCall_21_0() { return cHexStringTypeNameQualifiedNameParserRuleCall_21_0; }

		//";"
		public Keyword getSemicolonKeyword_22() { return cSemicolonKeyword_22; }

		//"array"
		public Keyword getArrayKeyword_23() { return cArrayKeyword_23; }

		//arrayTypeName=QualifiedName
		public Assignment getArrayTypeNameAssignment_24() { return cArrayTypeNameAssignment_24; }

		//QualifiedName
		public RuleCall getArrayTypeNameQualifiedNameParserRuleCall_24_0() { return cArrayTypeNameQualifiedNameParserRuleCall_24_0; }

		//";"
		public Keyword getSemicolonKeyword_25() { return cSemicolonKeyword_25; }

		//"boolean"
		public Keyword getBooleanKeyword_26() { return cBooleanKeyword_26; }

		//booleanTypeName=QualifiedName
		public Assignment getBooleanTypeNameAssignment_27() { return cBooleanTypeNameAssignment_27; }

		//QualifiedName
		public RuleCall getBooleanTypeNameQualifiedNameParserRuleCall_27_0() { return cBooleanTypeNameQualifiedNameParserRuleCall_27_0; }

		//";"
		public Keyword getSemicolonKeyword_28() { return cSemicolonKeyword_28; }

		//"number"
		public Keyword getNumberKeyword_29() { return cNumberKeyword_29; }

		//numberTypeName=QualifiedName
		public Assignment getNumberTypeNameAssignment_30() { return cNumberTypeNameAssignment_30; }

		//QualifiedName
		public RuleCall getNumberTypeNameQualifiedNameParserRuleCall_30_0() { return cNumberTypeNameQualifiedNameParserRuleCall_30_0; }

		//";"
		public Keyword getSemicolonKeyword_31() { return cSemicolonKeyword_31; }

		//"real"
		public Keyword getRealKeyword_32() { return cRealKeyword_32; }

		//realTypeName=QualifiedName
		public Assignment getRealTypeNameAssignment_33() { return cRealTypeNameAssignment_33; }

		//QualifiedName
		public RuleCall getRealTypeNameQualifiedNameParserRuleCall_33_0() { return cRealTypeNameQualifiedNameParserRuleCall_33_0; }
		...
		public Assignment getIntegerTypeNameAssignment_36() { return cIntegerTypeNameAssignment_36; }

		//QualifiedName
		public RuleCall getIntegerTypeNameQualifiedNameParserRuleCall_36_0() { return cIntegerTypeNameQualifiedNameParserRuleCall_36_0; }

		//";"
		public Keyword getSemicolonKeyword_37() { return cSemicolonKeyword_37; }

		//"null"
		public Keyword getNullKeyword_38() { return cNullKeyword_38; }

		//nullTypeName=QualifiedName
		public Assignment getNullTypeNameAssignment_39() { return cNullTypeNameAssignment_39; }

		//QualifiedName
		public RuleCall getNullTypeNameQualifiedNameParserRuleCall_39_0() { return cNullTypeNameQualifiedNameParserRuleCall_39_0; }

		//";"
		public Keyword getSemicolonKeyword_40() { return cSemicolonKeyword_40; }

		//"stream"
		public Keyword getStreamKeyword_41() { return cStreamKeyword_41; }

		//streamTypeName=QualifiedName
		public Assignment getStreamTypeNameAssignment_42() { return cStreamTypeNameAssignment_42; }

		//QualifiedName
		public RuleCall getStreamTypeNameQualifiedNameParserRuleCall_42_0() { return cStreamTypeNameQualifiedNameParserRuleCall_42_0; }
		...
		//"util-types"
		public Keyword getUtilTypesKeyword_45() { return cUtilTypesKeyword_45; }

		//"{"
		public Keyword getLeftCurlyBracketKeyword_46() { return cLeftCurlyBracketKeyword_46; }

		//"name-tree"
		public Keyword getNameTreeKeyword_47() { return cNameTreeKeyword_47; }

		//nameTreeTypeName=QualifiedName
		public Assignment getNameTreeTypeNameAssignment_48() { return cNameTreeTypeNameAssignment_48; }

		//QualifiedName
		public RuleCall getNameTreeTypeNameQualifiedNameParserRuleCall_48_0() { return cNameTreeTypeNameQualifiedNameParserRuleCall_48_0; }

		//";"
		public Keyword getSemicolonKeyword_49() { return cSemicolonKeyword_49; }

		//"number-tree"
		public Keyword getNumberTreeKeyword_50() { return cNumberTreeKeyword_50; }

		//numberTreeTypeName=QualifiedName
		public Assignment getNumberTreeTypeNameAssignment_51() { return cNumberTreeTypeNameAssignment_51; }

		//QualifiedName
		public RuleCall getNumberTreeTypeNameQualifiedNameParserRuleCall_51_0() { return cNumberTreeTypeNameQualifiedNameParserRuleCall_51_0; }

		//";"
		public Keyword getSemicolonKeyword_52() { return cSemicolonKeyword_52; }

		//"name-tree-parser"
		public Keyword getNameTreeParserKeyword_53() { return cNameTreeParserKeyword_53; }

		//nameTreeParserTypeName=QualifiedName
		public Assignment getNameTreeParserTypeNameAssignment_54() { return cNameTreeParserTypeNameAssignment_54; }

		//QualifiedName
		public RuleCall getNameTreeParserTypeNameQualifiedNameParserRuleCall_54_0() { return cNameTreeParserTypeNameQualifiedNameParserRuleCall_54_0; }

		//";"
		public Keyword getSemicolonKeyword_55() { return cSemicolonKeyword_55; }

		//"number-tree-parser"
		public Keyword getNumberTreeParserKeyword_56() { return cNumberTreeParserKeyword_56; }

		//numberTreeParserTypeName=QualifiedName
		public Assignment getNumberTreeParserTypeNameAssignment_57() { return cNumberTreeParserTypeNameAssignment_57; }

		//QualifiedName
		public RuleCall getNumberTreeParserTypeNameQualifiedNameParserRuleCall_57_0() { return cNumberTreeParserTypeNameQualifiedNameParserRuleCall_57_0; }

		//";"
		public Keyword getSemicolonKeyword_58() { return cSemicolonKeyword_58; }

		//"}"
		public Keyword getRightCurlyBracketKeyword_59() { return cRightCurlyBracketKeyword_59; }
	}
	...
	private ModelConfigElements pModelConfig;
	private CoreTypesConfigElements pCoreTypesConfig;
	...
	//ModelConfig:
	//	"config" "{" "base-package" basePackage=QualifiedName ";" coreTypesConfig=CoreTypesConfig "}";
	public ModelConfigElements getModelConfigAccess() {
		return (pModelConfig != null) ? pModelConfig : (pModelConfig = new ModelConfigElements());
	}
	
	public ParserRule getModelConfigRule() {
		return getModelConfigAccess().getRule();
	}
	...
	//	"name-tree-parser" nameTreeParserTypeName=QualifiedName ";" "number-tree-parser"
	//	numberTreeParserTypeName=QualifiedName ";" "}";
	public CoreTypesConfigElements getCoreTypesConfigAccess() {
		return (pCoreTypesConfig != null) ? pCoreTypesConfig : (pCoreTypesConfig = new CoreTypesConfigElements());
	}
	
	public ParserRule getCoreTypesConfigRule() {
		return getCoreTypesConfigAccess().getRule();
	}
