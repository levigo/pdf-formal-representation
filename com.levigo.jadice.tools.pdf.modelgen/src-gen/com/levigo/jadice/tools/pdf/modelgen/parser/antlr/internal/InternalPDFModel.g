...
entryRuleModelConfig returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getModelConfigRule()); }
	 iv_ruleModelConfig=ruleModelConfig 
	 { $current=$iv_ruleModelConfig.current; } 
	 EOF 
;

// Rule ModelConfig
ruleModelConfig returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='config' 
...
entryRuleCoreTypesConfig returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getCoreTypesConfigRule()); }
	 iv_ruleCoreTypesConfig=ruleCoreTypesConfig 
	 { $current=$iv_ruleCoreTypesConfig.current; } 
	 EOF 
;

// Rule CoreTypesConfig
ruleCoreTypesConfig returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='core-types' 
    {
